...
proc create_root_design { parentCell } {
  ...
  # connect_bd_net -net ps7_FCLK_CLK0 [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK]
  ...
  set_property PFM_NAME {xilinx.com:xd:zybo:1.0} [get_files [current_bd_design].bd]
